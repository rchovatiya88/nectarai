        ...
        <section className="relative flex min-h-[92vh] items-center px-6 pb-20 pt-32 md:px-24 md:pt-40">
          <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <p className="mb-4 font-mono text-sm uppercase tracking-widest text-nectar-honey">
                Pricing
              </p>
              ...
              <p className="max-w-2xl text-lg font-light leading-relaxed text-gray-300 md:text-xl">
                No hourly billing, no hidden fees. Each Bee is a flat monthly subscription.
                Add or remove Bees anytime. Start with a 14-day free trial.
              </p>
            ...
            >
              ...
              <div className="grid gap-4 pt-6 text-sm text-gray-300 sm:grid-cols-3">
                <div>
                  <p className="font-display text-3xl text-white">14</p>
                  <p className="mt-1">day free trial</p>
                </div>
                <div>
                  <p className="font-display text-3xl text-white">24/7</p>
                  <p className="mt-1">always-on workers</p>
                </div>
                <div>
                  <p className="font-display text-3xl text-white">0</p>
                  <p className="mt-1">setup fees</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section className="relative px-6 py-20 md:px-24" id="pricing">
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-gray-400">
              All plans include onboarding, training, and ongoing optimization. No contracts.
              Cancel anytime.
            </p>
          </div>
